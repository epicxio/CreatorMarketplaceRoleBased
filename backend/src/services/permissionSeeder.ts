...
import { allResources, permissionActions } from '../config/permissions';
...
export const syncPermissions = async () => {
  try {
    ...
    const dbPermissions: IPermission[] = await Permission.find({});

    const configPermissionKeys = new Set<string>();
